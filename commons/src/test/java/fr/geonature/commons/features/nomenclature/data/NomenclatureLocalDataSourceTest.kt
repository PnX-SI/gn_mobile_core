...
class NomenclatureLocalDataSourceTest {
    ...
    fun `should find all nomenclature types`() =
        runTest {
            ...
            assertEquals(
                expectedNomenclatureTypes.sortedBy { it.mnemonic },
                nomenclatureTypesFromDb
            )
        }

    @Test
    fun `should throw NoNomenclatureTypeFoundException if no nomenclature types was found`() =
        runTest {
            val exception =
                runCatching { nomenclatureLocalDataSource.getAllNomenclatureTypes() }.exceptionOrNull()

            assertTrue(exception is NomenclatureException.NoNomenclatureTypeFoundException)
        }
    ...
    @Test
    fun `should find nomenclatures by type with no taxonomy`() =
        runTest {
            initializeTaxonomy()
            initializeNomenclatureTypes()
            val expectedNomenclatures = initializeNomenclaturesByTypes()
    ...
    @Test
    fun `should find nomenclatures by type with any taxonomy`() =
        runTest {
            initializeTaxonomy()
            initializeNomenclatureTypes()
            val expectedNomenclatures = initializeNomenclaturesByTypes()
    ...
    @Test
    fun `should find nomenclatures by type matching given taxonomy kingdom`() =
        runTest {
            initializeTaxonomy()
            initializeNomenclatureTypes()
            val expectedNomenclatures = initializeNomenclaturesByTypes()
    ...
    @Test
    fun `should find nomenclatures by type matching given taxonomy kingdom and group`() =
        runTest {
            initializeTaxonomy()
            initializeNomenclatureTypes()
            val expectedNomenclatures = initializeNomenclaturesByTypes()
    ...
    @Test
    fun `should throw NoNomenclatureValuesFoundException if no nomenclature values was found from given mnemonic`() =
        runTest {
            initializeTaxonomy()
            initializeNomenclatureTypes()
            ...
            assertTrue(exception is NomenclatureException.NoNomenclatureValuesFoundException)
            assertEquals(
                "STATUT_BIO",
                (exception as NomenclatureException.NoNomenclatureValuesFoundException).mnemonic,
            )
        }
