...
class SQLiteSelectQueryBuilderTest {
    ...
    fun testDefaultSelect() {
        ...
        sqLiteQuery = SQLiteSelectQueryBuilder.from("user",
                                                    "u")
                .build()
    ...
    fun testFrom() {
        ...
        val sqLiteQuery = SQLiteSelectQueryBuilder.from("user",
                                                        "u")
                .from("profile",
                      "p")
                .column("u.email")
    ...
    fun testJoin() {
        ...
        sqLiteQuery = SQLiteSelectQueryBuilder.from("user",
                ...
                .column("u.login")
                .column("p.role")
                .join(SQLiteSelectQueryBuilder.JoinOperator.DEFAULT,
                      "group",
                      "g.name = ?",
                      "g",
                      "admin")
                .join(SQLiteSelectQueryBuilder.JoinOperator.LEFT_OUTER,
                      "user_group",
    ...
    fun testGroupByFromNonExistingColumn() {
        SQLiteSelectQueryBuilder.from("user",
                                      "u")
                .column("u.email")
                .groupBy("login")
                .build()
