...
* https://github.com/PnX-SI/gn_mobile_occtax[gn_mobile_occtax], the functional module for the "Occtax" application, supported by the national parks. This module is based on the two above-mentioned modules via git submodules.
